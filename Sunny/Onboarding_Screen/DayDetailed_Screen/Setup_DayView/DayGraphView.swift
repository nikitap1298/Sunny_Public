...
//  Sunny
//
//  Created by Nikita Pishchugin on 10.11.2022.
//

import UIKit
import DGCharts

class DayGraphView: UIView {
    ...
    private func setupUI() {
        ...
        yAxis.labelFont = UIFont(name: CustomFonts.nunitoMedium, size: 16) ?? .systemFont(ofSize: 16)
        ...
        yAxis.valueFormatter = YAxisValueFormatterTemperature()
        
        let xAxis = lineChartView.xAxis
        xAxis.labelFont = UIFont(name: CustomFonts.nunitoMedium, size: 16) ?? .systemFont(ofSize: 16)
