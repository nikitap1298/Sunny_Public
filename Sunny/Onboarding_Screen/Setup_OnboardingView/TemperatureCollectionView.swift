...
class CustomTemperatureCollectionCell: UICollectionViewCell {
    ...
    private func setupUI() {
        ...
        timeLabel.textColor = OnboardingColors.parametersText
        timeLabel.font = UIFont(name: CustomFonts.nunitoMedium, size: 12)
        
        temperatureLabel.textAlignment = .left
        temperatureLabel.textColor = OnboardingColors.parametersText1
        temperatureLabel.font = UIFont(name: CustomFonts.nunitoSemiBold, size: 16)
        ...
        NSLayoutConstraint.activate([
            ...
            conditionImage.trailingAnchor.constraint(equalTo: mainView.trailingAnchor, constant: -15),
            ...
            timeLabel.leadingAnchor.constraint(equalTo: mainView.leadingAnchor, constant: 15),
