...
struct TimeConverter {
    ...
    func convertToDayMonthNumber(_ date: String, timeZone: Int?) -> String {
    ...
    func convertToDayNumber(_ date: String, _ timeZone: Int?) -> String {
        let inputFormatter = DateFormatter()
        inputFormatter.dateFormat = "yyyy-MM-dd'T'HH:mm:ssZ"
    ...
    func convertTo24HourFormat(time: String) -> String {
        ...
        return "Error during converting 24 format in 12 format"
    }
}
