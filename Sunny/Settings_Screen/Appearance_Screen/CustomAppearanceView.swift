...
class CustomAppearanceView: UIView {
    ...
    private func setupStackOne() {
        ...
        lightLabel.text = L10nSettings.lightLabelText
        lightLabel.textAlignment = .center
        lightLabel.font = UIFont(name: CustomFonts.nunitoMedium, size: 16)
    ...
    private func setupStackTwo() {
        ...
        darkLabel.text = L10nSettings.darkLabelText
        darkLabel.textAlignment = .center
        darkLabel.font = UIFont(name: CustomFonts.nunitoMedium, size: 16)
    ...
    private func setupStackThree() {
        ...
        systemLabel.text = L10nSettings.systemLabelText
        systemLabel.textAlignment = .center
        systemLabel.font = UIFont(name: CustomFonts.nunitoMedium, size: 16)
