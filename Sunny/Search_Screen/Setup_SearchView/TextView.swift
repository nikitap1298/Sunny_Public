...
class TextView: UIView {
    ...
    private func setupUI() {
        ...
        searchTextField.attributedPlaceholder = NSAttributedString(
            string: L10nSearch.seacrhPlaceholderText,
            attributes: [NSAttributedString.Key.foregroundColor: SearchColors.searchTextFieldText ?? UIColor.systemGray,
                         NSAttributedString.Key.font: UIFont(name: CustomFonts.nunitoMedium, size: 17) ?? UIFont.systemFont(ofSize: 17)
                        ]
        )
        ...
        // Cancel Button
        cancelButton.setTitle(L10nSearch.cancelButtonText, for: .normal)
        cancelButton.setTitleColor(SearchColors.searchTextFieldText, for: .normal)
        cancelButton.titleLabel?.font = UIFont(name: CustomFonts.nunitoMedium, size: 17)
        ...
        NSLayoutConstraint.activate([
            ...
            searchTextField.trailingAnchor.constraint(equalTo: mainView.centerXAnchor, constant: 60),
